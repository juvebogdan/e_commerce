    ...
    return Column(
      children: [
        Padding(
          ...
          child: SectionTitle(
            title: AppTranslations.specialForYou,
            press: () {},
          ),
        ),
          ...
          child: Row(
            children: [
              SpecialOfferCard(
                ...
                category: AppTranslations.smartphone,
                numOfBrands: 18,
                press: () {},
              ),
              SpecialOfferCard(
                image: "assets/images/Image Banner 3.png",
                category: AppTranslations.fashion,
                numOfBrands: 24,
                press: () {},
              ),
          ...
          child: ClipRRect(
            ...
            child: Stack(
              children: [
                ...
                Padding(
                  padding: EdgeInsets.symmetric(
                    horizontal: SizeConfig.getProportionateScreenWidth(15.0),
                  ...
                  child: Text.rich(
                    TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(text: "$numOfBrands ${AppTranslations.brands}")
                      ],
                    ),
                  ),
                ),
